...
const EditJobPage = ({ updateSubmitJobs }) => {
      ...
      <div className="container m-auto max-w-2xl py-24">
        <div
          ...
          <form onSubmit={submitForm}>
            ...
            <div className="mb-4">
              <label htmlFor="type" 
              className="block text-gray-700 font-bold mb-2">Job Type</label>
              <select
                id="type"
                name="type"
            ...
            <div className="mb-4">
              <label 
              htmlFor='title'
              className="block text-gray-700 font-bold mb-2">Job Listing Name</label>
              <input
                type="text"
                id="title"
                name="title"
            ...
            <div className="mb-4">
              ...
              className="block text-gray-700 font-bold mb-2">Salary</label>
              <select
                id="salary"
                name="salary"
                className="border rounded w-full py-2 px-3"
